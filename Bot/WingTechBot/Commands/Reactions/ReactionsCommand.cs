...
///Used for totalling up how many reactions of each emote users have received.
public sealed partial class ReactionsCommand : SlashCommand
{
	public override async Task SetUp(WingTechBot bot)
	{
		...
		var reactionsCommand = new SlashCommandBuilder().WithName("reactions").WithDescription("Shows totals for all reactions you have received this year");
		...
		{
			Logger.LogLine("Error adding command");
